...
<body class="relative min-h-screen w-full overflow-hidden">
    ...
    <div class="absolute h-full left-[78px] transition-all duration-500 ease content" style="width: calc(100% - 78px);">
        <div class="mr-5 ml-[130px] my-5">
            <div class="mb-4">
                <a href="actions/add_assistant.php" class="bg-darksystem text-white px-4 py-2 rounded-lg shadow-md hover:bg-gray-800 transition-all duration-300 ease text-lg shadow-custom hover:bg-darkmode">
                    Add Assistant
                </a>
            </div>
                ...
                <table class="max-w-ful bg-white border border-gray-200 rounded-lg shadow-md">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center text-lg hover:bg-gray-50">
                            <td class="py-2 px-4 border"><?= $as["id"]; ?></td>
                            <td class="py-2 px-4 border"><?= $as["nim"]; ?></td>
                            <td class="py-2 px-4 border"><?= $as["name"]; ?></td>
                            <td class="py-2 px-4 border"><?= $as["code"]; ?></td>
                            <td class="py-2 px-4 border">
                                <a href="actions/edit_assistant.php?id=<?= $as["id"]; ?>" class="text-blue-500 hover:underline mr-2">Edit</a>
                                <a href="actions/rm_asisten.php?id=<?= $as["id"]; ?>" class="text-red-500 hover:underline">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>    
                    </tbody>
